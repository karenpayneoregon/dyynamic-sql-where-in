...
namespace UnitTestProject.Base
{
    public class TestBase
    {
        ...
        /// </remarks>
        public (List<int> list, Exception exception) GetCustomersKeysBack(List<string> pNames)
        {
        ...
        public (List<string> list, Exception exception) GetCustomersNamesBack(List<string> pNames)
        {
        ...
        public (List<string> list, Exception exception) GetByPrimaryKeys(List<int> pIdentifiers)
        {
        ...
        public (List<string> list, Exception exception) GetByPrimaryKeys_NotIn(List<int> pIdentifiers)
        {
        ...
        /// </remarks>
        public (List<int> list, Exception exception) GetStartDatesList(List<string> pStartDates)
        {
